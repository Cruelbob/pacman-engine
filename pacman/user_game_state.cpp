...
void user_game_state::initialize() {
}
void user_game_state::input(const std::vector<input_event_t>& in_events) {
}
void user_game_state::update(const time_type& delta) {
}
void user_game_state::pre_next_state() {
}
...
void user_game_state::set_graphics_contex(const std::shared_ptr<user_graphics_context>& p_graphics_ctx) {
	p_graphics_context = p_graphics_ctx;
}

void user_game_state::set_audio_context(const std::shared_ptr<user_audio_context>& p_audio_ctx) {
    p_audio_context = p_audio_ctx;
}
...
void user_game_state::set_next_state(std::unique_ptr<game_state>&& p_state) {
	if(state_change_clbk) {
		...
		throw std::runtime_error("user_game_state::set_state_change_callback was not called");
	}
}
